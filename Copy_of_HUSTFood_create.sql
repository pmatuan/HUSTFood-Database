...
CREATE TABLE customer_payment (
    id int  NOT NULL,
    customer_id int  NOT NULL,
    payment_type char(20) CHECK(payment_type IN ('MOMO','ZALOPAY', 'VTMONEY', 'SHOPEEPAY', NULL)) DEFAULT NULL,
...
-- foreign keys
-- Reference: Table_16_customer (table: customer_payment)
ALTER TABLE customer_payment ADD CONSTRAINT Table_16_customer
